<h2>This is a project based on Java and HTML where you can Learn (Selenium WebDriver)  with all kind of enviroments and steps from simple browser to Appium</h2>
